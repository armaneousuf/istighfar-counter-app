...
4. open script.js and find this line `const APP_LAST_UPDATED = "2026-09-19";` and change the date when it last updated
5. Run `npx cap sync android`, then build the app. The APK will automatically be named `istighfar-app-v3.4.apk`.
